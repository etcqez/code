  ...
  methods: {
    ...
    changIsShow (data) {
      ...
      this.$http({
        ...
        url: this.$http.adornUrl('/commodity/brand/update/isshowiei'),
        method: 'post',
        // {id, isshow} 是json数据，完整写法是 {"id":id, "isshow":isshow}
        // 当key和值名一致时，可以简写成 {id,isshow}
